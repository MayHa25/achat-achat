...
import { Appointment, Business, Client, Service, Availability, BlockedTime, User } from '../types';
...
const useStore = create<AppState>((set) => ({
  ...
  updateAvailability: (availability) => set((state) => ({ 
    availabilities: state.availabilities.map(a => a.id === availability.id ? availability : a) 
  })),
